...
void split_shooting_star_white()
{
  ...
  leds[pos_2] = CHSV(start_hue, 0, 255);
  leds[pos_3] = CHSV(start_hue, 0, 255);
  leds[pos_4] = CHSV(start_hue, 0, 255);
  leds[pos_5] = CHSV(start_hue, 0, 255);
  leds[pos_6] = CHSV(start_hue, 0, 255);
  FastLED.show();
  start_hue += delta_hue;
}