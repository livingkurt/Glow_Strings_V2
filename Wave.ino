...
uint16_t wave_white_mirror_pos_1 = NUM_LEDS / 2;
uint16_t wave_white_mirror_pos_2 = NUM_LEDS / 2;
...
void wave_white_mirror()
{
  ...
  static int last_wave_white_mirror_pos_1 = NUM_LEDS / 2;
  static int last_wave_white_mirror_pos_2 = NUM_LEDS / 2;
  if (wave_white_mirror_pos_1 > rand_length)
  {
    wave_white_mirror_pos_1 = NUM_LEDS / 2;
    fill_solid(leds, NUM_LEDS, CHSV(0, 0, 0));
  }
  else
  {
    wave_white_mirror_pos_1--;
  }
  if (wave_white_mirror_pos_2 > rand_length)
  {
    wave_white_mirror_pos_2 = NUM_LEDS / 2;
    // fill_solid(leds, NUM_LEDS, CHSV(0, 0, 0));
  }
  else
  {
    wave_white_mirror_pos_2++;
  }
  // fadeToBlackBy(leds, NUM_LEDS, 200); //change fadeby to smaller or larger number to adjust the length of the tail.
...
void wave_rainbow_shooting_star()
{
  ...
  {
    wave_rainbow_shooting_star_pos++;
  }
...
void wave_white_mirror_shooting_star()
{
  ...
  {
    wave_white_mirror_shooting_star_pos_1--;
  }
  ...
  {
    wave_white_mirror_shooting_star_pos_2++;
  }
  fadeToBlackBy(leds, NUM_LEDS, 200); //change fadeby to smaller or larger number to adjust the length of the tail.
...
void wave_rainbow_mirror_shooting_star()
{
  ...
  {
    wave_rainbow_mirror_shooting_star_pos_1--;
  }
  ...
  {
    wave_rainbow_mirror_shooting_star_pos_2++;
  }
